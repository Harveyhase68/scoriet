                ...
                <table class="table">
                    <tr style="text-align: center">
                        <td<?php if (USER_CAN_REGISTER) {
                            ...
                            <?php if (OFFLINE) {?>
                                <hr>
                                <h3 class="text-center" style="color: #b92c28">This site is currently offline</h3>
                            <?php } ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <h2 class="form-signin-heading" style="text-align: center">Customer Login</h2>
                            <div class="form-inner-container">
                                ...
                                <hr>
                                <label>Forgot Password?<a href="password_forgot.php"<?php if (OFFLINE) { echo ' onclick="return false;"';}?>>&nbsp;Reset Password</a></label>
                            </div>
                        </td>
                        <?php if (USER_CAN_REGISTER) { ?>
                            <td style="max-width: 350px">
                                <h2 class="form-signin-heading" style="text-align: center"> New customers </h2>
                                <div class="form-inner-container">
                                    <div class="form-control-static">
                                        <span>Here you can register at <?php echo COMPANY; ?></span>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" name="btn-register" class="btn btn-info"<?php if (OFFLINE || REGISTER_OFFLINE) { echo "disabled";}?>>
                                            <i class="glyphicon glyphicon-thumbs-up"></i>&nbsp;Register here
                                        </button>
                                    </div>
                                </div>
                            </td>
