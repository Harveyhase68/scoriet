		...
		<div class="jumbotron">
			...
			<table width="100%">
				<tr>
					...
					<td width="10%">
							<a href="#" class="btn btn-danger" onclick="delete_selected();">Delete</a>
					</td>
					<td width="10%">
							<a href="print_{filename}.php" class="btn btn-info" target="_blank">Print</a>
					</td>
...
{endfor}
							echo '					<td>'; echo "\r\n";
							echo '						<a class="btn btn-primary" href="read_{filename}.php?id='.$row['{filekeyname}'].'">Display</a>'; echo "\r\n";
							echo '						&nbsp;'; echo "\r\n";
							echo '					<td>'; echo "\r\n";
							echo '						<a class="btn btn-success" href="update_{filename}.php?id='.$row['{filekeyname}'].'">Modify</a>'; echo "\r\n";
							echo '						&nbsp;'; echo "\r\n";
							echo '					<td>'; echo "\r\n";							
							echo '						<a class="btn btn-danger" href="delete_{filename}.php?id='.$row['{filekeyname}'].'">Delete</a>'; echo "\r\n";
							echo '					</td>'; echo "\r\n";
							echo '				</tr>'; echo "\r\n";
				   }
				  ?>
...
?>
					...
					<li class="page-item">
						<label class="checkbox-inline" for="bl1_id" style="margin-left:25px;margin-top:7px;float:left;">Browse:</label>
