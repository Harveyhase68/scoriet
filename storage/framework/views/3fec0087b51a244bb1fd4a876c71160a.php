...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses(['dark' => ($appearance ?? 'system') == 'dark']); ?>">
    <head>
        ...
        <title inertia><?php echo e(config('app.name', 'Scoriet')); ?> – Schema-to-Stack Studio</title>
        ...
        <meta property="og:title" content="<?php echo e(config('app.name', 'Scoriet')); ?> – Schema-to-Stack Studio">
        ...
        <meta name="twitter:title" content="<?php echo e(config('app.name', 'Scoriet')); ?> – Schema-to-Stack Studio">
