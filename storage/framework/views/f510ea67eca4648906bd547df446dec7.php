...
<head>
    ...
    <title>Neue Nachricht - <?php echo e($thread->subject); ?></title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <div class="attachments">
            <div class="attachments-title">
                📎 <?php echo e(count($attachments)); ?> <?php echo e(count($attachments) === 1 ? 'Anhang' : 'Anhänge'); ?>
            ...
            <div class="attachment-item">
                <a href="<?php echo $attachment->getSignedDownloadUrl(); ?>" class="attachment-link" target="_blank">
                    ...
                    <div class="attachment-info">
                        ...
                        <div class="attachment-size"><?php echo e($attachment->getFormattedSize()); ?> - Klicken zum Herunterladen</div>
                    </div>
                </a>
            </div>
        ...
        <div class="timestamp">
            Gesendet am <?php echo e($userMessage->created_at->format('d.m.Y \u\m H:i')); ?> Uhr
        </div>

        <div class="actions">
            <a href="<?php echo e($viewUrl); ?>" class="btn">Nachricht lesen</a>
        </div>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 15px; font-size: 12px; color: #9ca3af;">
                Thread ID: <?php echo e($thread->id); ?>
