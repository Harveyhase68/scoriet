        ...
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                ...
                <p class="mt-1 text-sm text-gray-300">
                    Update the content for <?php echo e($page->slug); ?> in <?php echo e(strtoupper($page->locale)); ?>.
                </p>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="is_active" id="is_active" value="1" <?php echo e(old('is_active', $page->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.static', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp\www\scoriet\resources\views/admin/pages/edit.blade.php ENDPATH**/ ?>