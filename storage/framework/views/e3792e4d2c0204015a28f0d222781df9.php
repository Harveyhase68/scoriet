...
<body>
    <div class="container">
        ...
        <p>
            ...
            Ihr letzter Login war am <strong><?php echo e($lastLoginAt); ?></strong>.
        </p>
        ...
        <div class="actions">
            <a href="<?php echo e($loginUrl); ?>" class="btn btn-warning">Jetzt einloggen</a>
        </div>
...
<?php /**PATH C:\wamp\www\scoriet\resources\views/emails/inactivity-warning-2.blade.php ENDPATH**/ ?>