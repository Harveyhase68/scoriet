...
<head>
    ...
    <title>Abo läuft bald ab - <?php echo e($displayName); ?></title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <div class="warning-banner">
            ...
            <p style="margin: 0; color: #92400e;">
                Verlängern Sie jetzt und sichern Sie sich einen Bonus von <strong><?php echo e($bonusDays); ?> Tagen</strong> gratis!
            </p>
        </div>

        <div class="countdown"><?php echo e($daysUntilExpiry); ?></div>
        <div class="countdown-label">Tage verbleibend</div>

        <div class="subscription-info">
            <div class="subscription-name"><?php echo e($displayName); ?></div>
            <p class="subscription-expiry">
                Läuft ab am: <?php echo e($expiresAt); ?>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 15px; font-size: 12px; color: #9ca3af;">
                Subscription ID: <?php echo e($subscription->id); ?>
...
<?php /**PATH C:\wamp\www\scoriet\resources\views/emails/subscription-expiry-warning.blade.php ENDPATH**/ ?>