...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - <?php echo e(config('app.name', 'Scoriet')); ?></title>
            ...
            <div style="max-width: 80rem; margin: 0 auto; padding: 0 1rem;">
                <div style="display: flex; justify-content: space-between; align-items: center; height: 4rem;">
                    ...
                    <div style="display: flex; align-items: center; gap: 0.5rem;">
                        ...
                        <?php if(str_contains(request()->path(), 'admin')): ?>
                        ...
                        <?php else: ?>
                            <a href="/<?php echo e(app()->getLocale()); ?>/help" style="color: rgba(255, 255, 255, 0.9); padding: 0.375rem 0.75rem; font-size: 0.875rem; font-weight: 500; text-decoration: none; border-radius: 0.5rem; transition: color 0.2s;"><?php echo e(__('pages.help.title') ?? 'Help'); ?></a>
                            <a href="/<?php echo e(app()->getLocale()); ?>/impressum" style="color: rgba(255, 255, 255, 0.9); padding: 0.375rem 0.75rem; font-size: 0.875rem; font-weight: 500; text-decoration: none; border-radius: 0.5rem; transition: color 0.2s;">Impressum</a>
                        <?php endif; ?>
            ...
            <div style="max-width: 80rem; margin: 0 auto; padding: 0 1rem;">
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem;">
                    ...
                    <div>
                        ...
                        <ul style="list-style: none; padding: 0; margin: 0;">
                            <li style="margin-bottom: 0.5rem;"><a href="/<?php echo e(app()->getLocale()); ?>/help" style="color: #9ca3af; text-decoration: none; transition: color 0.2s;"><?php echo e(__('pages.help.title') ?? 'Help'); ?></a></li>
                            <li style="margin-bottom: 0.5rem;"><a href="/<?php echo e(app()->getLocale()); ?>/impressum" style="color: #9ca3af; text-decoration: none; transition: color 0.2s;">Impressum</a></li>
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; color: #9ca3af;">
                    <p>&copy; <?php echo e(date('Y')); ?> Scoriet. All rights reserved.</p>
...
</html><?php /**PATH C:\wamp\www\scoriet\resources\views/layouts/static.blade.php ENDPATH**/ ?>