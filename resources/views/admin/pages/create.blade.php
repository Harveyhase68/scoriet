    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                <h3 class="text-lg font-medium leading-6 text-white">Create New Page</h3>
                ...
                <div class="shadow-lg sm:overflow-hidden sm:rounded-md">
                    <div class="space-y-6 bg-gray-800 px-4 py-5 sm:p-6">
                        <div>
                            ...
                            @enderror
                            <p class="mt-1 text-sm text-gray-400">URL-friendly identifier (lowercase, hyphens allowed)</p>
                        </div>

                        <div>
                            <label for="locale" class="block text-sm font-medium text-gray-300">Language</label>
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="is_active" class="ml-2 block text-sm text-white">
                                Active (page will be visible to visitors)
                            </label>
                        </div>
                    </div>
