    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                <h3 class="text-lg font-medium leading-6 text-white">{{__('editbladephp8')}}</h3>
                <p class="mt-1 text-sm text-gray-300">
                    {{__('editbladephp10')}}{{ $page->slug }}{{__('editbladephp10_2')}}{{ strtoupper($page->locale) }}.
                </p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.pages.update', $page) }}" method="POST">
                ...
                <div class="shadow-lg sm:overflow-hidden sm:rounded-md">
                    <div class="space-y-6 bg-gray-800 px-4 py-5 sm:p-6">
                        <div>
                            <label for="title" class="block text-sm font-medium text-gray-300">{{__('editbladephp22')}}</label>
