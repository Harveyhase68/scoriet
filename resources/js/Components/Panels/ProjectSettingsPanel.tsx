        ...
        <div className="h-full flex flex-col bg-gray-800 text-gray-100 p-6 overflow-auto project-settings-panel">
            ...
            <Tabs
                ...
                items={[
                    {
                        key: '1',
                        label: <span><i className="pi pi-cog mr-2"></i>Allgemein</span>,
                        children: (
                    ...
                    {
                        key: '2',
                        label: <span><i className="pi pi-database mr-2"></i>Datenbank</span>,
                        children: (
                            <div className="space-y-4 max-w-3xl">
                                <div>
                                    <label className="block text-sm font-medium text-gray-300 mb-2">
                    ...
                    {
                        key: '3',
                        label: <span><i className="pi pi-file mr-2"></i>Eigenschaften</span>,
                        children: (
                            <div className="space-y-4 max-w-3xl">
                                <div>
                                    <label className="block text-sm font-medium text-gray-300 mb-2">
                    ...
                    {
                        key: '4',
                        label: <span><i className="pi pi-globe mr-2"></i>Lokalisierung</span>,
                        children: (
                            <div className="space-y-4 max-w-3xl">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                    ...
                    {
                        key: '5',
                        label: <span><i className="pi pi-comments mr-2"></i>Sprachen</span>,
                        children: (
