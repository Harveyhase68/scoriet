...
export const de: Translations = {
  ...
  fixtemplatefilepaths30: 'Suche nach Vorlagendateien mit leerem Dateipfad ...',
  fixtemplatefilepaths43: 'Es wurden {$emptyCount} Dateien mit leerem Dateipfad von insgesamt {$totalFiles} Dateien gefunden',
  fixtemplatefilepaths46: 'Alle Vorlagendateien haben bereits Dateipfadwerte!',
  ...
  fixtemplatefilepaths74: '{$fixedCount} Vorlagendateipfade erfolgreich behoben!',
  ...
  testobservers92: '✅ Vorlage erstellt: {$template->id}',
  testobservers98: 'Hallo Welt',
  testobservers103: '✅ Datei zur Vorlage hinzugefügt',
  testobservers106: 'Aktualisierte Beschreibung',
  testobservers107: '✅ Aktualisierte Vorlage',
  testobservers111: '✅ Vorlage gelöscht',
  testobservers114: '❌ Vorlagen-Beobachtertest fehlgeschlagen:',
  testobservers120: '📄 TemplateFile Observer testen …',
  testobservers126: 'Testvorlage für Dateibeobachter',
  testobservers139: 'Testdatei',
  testobservers144: '✅ Vorlagendatei erstellt: {$file->id}',
  testobservers147: 'Aktualisierter Inhalt',
  testobservers148: '✅ Aktualisierte Vorlagendatei',
  testobservers152: '✅ Gelöschte Vorlagendatei',
  ...
  testobservers247: '⚠️ Keine Vorlage gefunden',
  ...
  testtreegenerator52: 'Aktive Vorlagenverwendungen:',
  testtreegenerator62: 'Generierte Baumknoten:',
  testtreegenerator71: 'Vorlagendateien {$usage->template_id} ({$template->name}):',
  ...
  testtreeupdate48: 'Vorlage: {$templateGroup[',
  ...
  templatecontroller96: 'Diese Vorlage kann nicht verwendet werden',
  templatecontroller101: 'Die Vorlage wird bereits von diesem Projekt verwendet',
  templatecontroller108: 'Vorlage erfolgreich verknüpft',
  templatecontroller129: 'Der Vorlagenname muss aus Kleinbuchstaben bestehen',
  templatecontroller141: 'Nicht autorisierter Zugriff auf dieses Projekt',
  templatecontroller145: 'Diese Vorlage kann nicht geklont werden',
  templatecontroller156: 'Vorlage erfolgreich geklont',
  templatecontroller170: 'Nicht autorisiert',
  templatecontroller245: 'Nicht autorisierter Zugriff auf dieses Projekt',
  templatecontroller268: '{$assignedCount} Vorlage(n) erfolgreich dem Projekt zugewiesen',
  templatecontroller288: 'Projekt nicht gefunden',
  templatecontroller292: 'Vorlage nicht gefunden',
  templatecontroller297: 'Nicht autorisierter Zugriff auf dieses Projekt',
  templatecontroller307: 'Die Vorlage ist diesem Projekt nicht zugewiesen',
  templatecontroller314: 'Vorlage erfolgreich aus dem Projekt entfernt',
  templatecontroller333: 'Nicht autorisiert',
  templatecontroller338: 'Vorlagenverwendung erfolgreich entfernt',
  ...
  templatecontroller537: 'Vorlage erfolgreich gelöscht',
  ...
  templatecontroller567: 'Vorlage endgültig gelöscht',
  ...
  templatecontroller591: 'Vorlage erfolgreich deaktiviert',
  ...
  templatecontroller717: 'Das Laden der Vorlagenabhängigkeiten ist fehlgeschlagen',
  ...
  templatecontroller944: '🧪 [API-TEMPLATE-QUEUE] Job-Versand für Vorlage {$template->id} ({$template->name}) wird gestartet',
  templatecontroller954: '🧪 [API-TEMPLATE-QUEUE] Gefundene Projekt-IDs:',
  templatecontroller957: '🧪 [API-TEMPLATE-QUEUE] Vorlage {$template->id}: Noch keine Projekte, die diese Vorlage verwenden',
  templatecontroller961: '🧪 [API-TEMPLATE-QUEUE] Vorlage {$template->id}: Regeneration wird versendet für',
  ...
  templatecontroller985: '🧪 [API-TEMPLATE-QUEUE] Auftragsversand für Vorlage {$template->id} abgeschlossen',
  ...
  ultimatetemplatecontroller42: 'Vorlage nicht gefunden',
  ultimatetemplatecontroller55: '🚀 Hauptprozessvorlage: templateId=$templateId',
  ultimatetemplatecontroller102: 'Die Verarbeitung der ultimativen Vorlage ist fehlgeschlagen',
  ...
  ultimatetemplatecontroller241: 'Ultimative Scoriet-Vorlagen-Engine',
  ...
  dbschemacontroller145: 'Sie können diese Vorlage nicht bearbeiten',
  dbschemacontroller157: 'Die Vorlage ist bereits mit diesem DB-Schema verknüpft',
  dbschemacontroller171: 'Vorlage erfolgreich mit DB-Schema verknüpft',
  dbschemacontroller195: 'Sie können diese Vorlage nicht bearbeiten',
  dbschemacontroller207: 'Vorlage erfolgreich vom DB-Schema getrennt',
  ...
  schemacontroller225: 'Schema kann nicht gelöscht werden. Es wird von {$dependentTemplates} Vorlage(n) verwendet.',
  ...
  schemacontroller306: 'Sie können diese Vorlage nicht bearbeiten',
  schemacontroller318: 'Die Vorlage ist bereits mit diesem Schema verknüpft.',
  schemacontroller332: 'Vorlage erfolgreich mit Schema verknüpft',
  schemacontroller356: 'Sie können diese Vorlage nicht bearbeiten',
  schemacontroller368: 'Die Verknüpfung der Vorlage mit dem Schema wurde erfolgreich aufgehoben.',
  ...
  templatecontroller98: 'Vorlage nicht gefunden',
  templatecontroller140: 'Vorlagen/{$template->id}/{$fileData[',
  templatecontroller154: 'Vorlage erfolgreich erstellt',
  templatecontroller222: 'Vorlage erfolgreich aktualisiert',
  templatecontroller243: 'Vorlage erfolgreich gelöscht',
  templatecontroller306: 'Vorlagenzuweisung wird derzeit simuliert – Datenbankintegration steht noch aus',
  templatecontroller328: 'Vorlagenentfernung erfolgreich simuliert',
  templatecontroller329: 'Das Entfernen der Vorlage wird derzeit simuliert – die Datenbankintegration steht noch aus',
  templatecontroller334: 'Simulierte Entfernung fehlgeschlagen',
  templatecontroller369: 'Scoriet-Vorlagenmanager',
  templatecontroller382: 'Vorlage nicht gefunden',
  templatecontroller420: 'Vorlage mit diesem Namen ist bereits vorhanden. Setzen Sie overwrite_existing auf „true“, um sie zu ersetzen.',
  templatecontroller445: 'Vorlagen/{$template->id}/{$fileData[',
  templatecontroller455: 'Vorlage erfolgreich importiert',
  templatecontroller481: 'Vorlage nicht gefunden',
  templatecontroller493: 'Anforderung zur DB-Schemaabhängigkeit hinzufügen',
  templatecontroller509: 'Sie können dieser Vorlage keine Abhängigkeiten hinzufügen',
  ...
  templatecontroller561: 'Die Vorlage hängt bereits von diesem DB-Schema ab',
  ...
  templatecontroller616: 'Sie können keine Abhängigkeiten aus dieser Vorlage entfernen',
  templatecontroller628: 'DB-Schemaabhängigkeit erfolgreich entfernt',
  templatecontroller633: 'Abhängigkeit nicht gefunden',
  templatecontroller654: 'Sie können die Abhängigkeiten für diese Vorlage nicht aktualisieren',
  ...
  templatecontroller723: '🧪 [TEMPLATE-QUEUE] Starte Job-Versand für Vorlage {$template->id} ({$template->name})',
  templatecontroller733: '🧪 [TEMPLATE-QUEUE] Gefundene Projekt-IDs:',
  templatecontroller736: '🧪 [TEMPLATE-QUEUE] Vorlage {$template->id}: Noch keine Projekte, die diese Vorlage verwenden',
  templatecontroller740: '🧪 [TEMPLATE-QUEUE] Vorlage {$template->id}: Regeneration wird versendet für',
  ...
  templatecontroller765: '🧪 [TEMPLATE-QUEUE] Auftragsversand für Vorlage {$template->id} abgeschlossen',
  ...
  templatefileobserver17: '📄 [TEMPLATE-FILE-OBSERVER] erstelltes Ereignis ausgelöst für Datei {$templateFile->id} (Vorlage: {$templateFile->template_id})',
  templatefileobserver26: '📄 [TEMPLATE-FILE-OBSERVER] Aktualisiertes Ereignis für Datei {$templateFile->id} ausgelöst (Vorlage: {$templateFile->template_id})',
  templatefileobserver35: '📄 [TEMPLATE-FILE-OBSERVER] gelöschtes Ereignis für Datei {$templateFile->id} ausgelöst (Vorlage: {$templateFile->template_id})',
  ...
  templateobserver17: '🧪 [TEMPLATE-OBSERVER] hat ein Ereignis für die Vorlage {$template->id} ({$template->name}) ausgelöst.',
  templateobserver53: 'Vorlage {$template->id} wurde zwangsweise gelöscht',
  templateobserver70: 'Vorlage {$template->id} ({$action}): Keine Projekte betroffen',
  templateobserver74: 'Vorlage {$template->id} ({$action}): Regeneration wird versendet für',
  ...
  ultimatetemplateengine968: '// Integrierte Vorlagenfunktionen',
  ...
  planmodal49: 'Grundlegende Vorlagen',
  ...
  planmodal65: 'Erweiterte Vorlagen',
  planmodal66: 'Benutzerdefinierte Vorlagenerstellung',
  ...
  profilemodal510: 'Sprache auswählen',
  ...
  // resources/js\Components\AuthModals\ProfileModal.tsx
  profilemodal718: 'Alle Ihre Projekte und Vorlagen werden gelöscht',
  ...
  codegenerationpanel286: '# Generierte Codedateien aus dem Vorlagensystem',
  ...
  // resources/js\Components\Panels\CodeGenerationPanel.tsx
  codegenerationpanel338: 'Geben Sie die Vorlagen-ID ein (z. B. 1).',
  ...
  databasemanagementpanel756: 'Im Designer öffnen',
  ...
  databasemanagementpanel1163: '⚠️ Warnung vor dauerhafter Löschung',
  databasemanagementpanel1166: 'ALLE',
  databasemanagementpanel1174: '🎨 Alle Schema-Designer-Layouts',
  ...
  databasemanagementpanel1217: '🗑️ Für immer löschen',
  ...
  debugmanualgeneratorpanel1259: '🔧 Debug-Handbuchgenerator',

  // resources/js/Components/Panels/DebugManualGeneratorPanel.tsx
  debugmanualgeneratorpanel1260: 'Vorlagenentwicklung und Code-Debugging für einzelne Dateien',
  ...
  debugmanualgeneratorpanel1325: 'Nicht benötigt für diesen File-Typ',
  debugmanualgeneratorpanel1334: '(nicht benötigt)',
  ...
  debugmanualgeneratorpanel1397: 'Nicht ausgewählt',
  debugmanualgeneratorpanel1398: 'Unbekannt',
  debugmanualgeneratorpanel1399: 'Nicht ausgewählt',
  debugmanualgeneratorpanel1400: 'Nicht ausgewählt',
  debugmanualgeneratorpanel1473: '🔴 Kein Projekt für die Projektdateivorlage ausgewählt',
  debugmanualgeneratorpanel1476: '🔴 Keine Tabelle für die db_table_file-Vorlage ausgewählt',
  debugmanualgeneratorpanel1479: '🟡 Keine Sprache für sprachfähige Vorlage ausgewählt',
  ...
  debugmanualgeneratorpanel1739: 'Kurier Neu',
  ...
  debugmanualgeneratorpanel1755: 'Kurier Neu',
  ...
  panelsewnavigationpanel184: 'Vorlagen',
  panelsewnavigationpanel188: 'Template Verwaltung',
  panelsewnavigationpanel193: 'Vorlagenzuweisung',
  ...
  panelsewnavigationpanel246: 'SQL importieren',
  ...
  panelsewnavigationpanel496: 'Vorlagen',
  panelsewnavigationpanel504: 'Template Verwaltung',
  panelsewnavigationpanel508: 'Vorlagenzuweisung',
  ...
  newnavigationpanel184: 'Vorlagen',
  newnavigationpanel188: 'Template Verwaltung',
  newnavigationpanel193: 'Vorlagenzuweisung',
  ...
  newnavigationpanel496: 'Vorlagen',
  newnavigationpanel504: 'Template Verwaltung',
  newnavigationpanel508: 'Vorlagenzuweisung',
  ...
  panelt1856: 'Tisch:',
  panelt1859: 'Sprache:',
  panelt1873: 'Gesamtanzahl der Artikel',
  ...
  panelt390: 'Das Laden der Vorlagen ist fehlgeschlagen',
  panelt3103: 'Fehler beim Laden der Vorlagen',
  ...
  panelt3219: 'Fehler beim Zuweisen von Vorlagen',
  panelt3231: 'Fehler beim Zuweisen von Vorlagen',
  panelt3245: 'Nicht authentifiziert',
  panelt3250: 'LÖSCHEN',
  panelt3272: 'Fehler beim Entfernen der Vorlage',
  panelt3287: 'Alle',
  ...
  // resources/js/Components/Panels/PanelT3.tsx
  templatesWorkingOn: 'von {selectedProject.owner.name}',
  ...
  panelt5274: 'Typ:',
  panelt5275: 'AUSWEIS:',
  panelt5286: 'Gesamtanzahl der Artikel',
  ...
  projectpanel1550: '📄 Verknüpfte Vorlagen',

  // resources/js\Components\Panels\ProjectPanel.tsx
  projectpanel1556: '📄 Verknüpfte Vorlagen',
  projectpanel1560: 'Vorlagen werden geladen …',

  // resources/js/Components/Panels/ProjectPanel.tsx
  projectpanel1563: 'Mit diesem Projekt sind noch keine Vorlagen verknüpft.',
  ...
  projectsettingspanel734: 'Suchen...',
  ...
  schematranslationpanel820: 'Projekt: {selectedProject.name}',
  ...
  // resources/js\Components\Panels\TemplateDbSchemaDependenciesPanel.tsx
  templatedbschemadependenciespanel231: 'Geben Sie einen Alias für dieses DB-Schema in der Vorlage ein',
  templatedbschemadependenciespanel242: 'Stornieren',
  templatedbschemadependenciespanel248: 'Abhängigkeit hinzufügen',
  templatedbschemadependenciespanel324: 'Das Laden der Vorlagen ist fehlgeschlagen',
  templatedbschemadependenciespanel346: 'Das Laden der Vorlagenabhängigkeiten ist fehlgeschlagen',
  templatedbschemadependenciespanel350: 'Das Laden der Vorlagenabhängigkeiten ist fehlgeschlagen',
  ...
  templatedbschemadependenciespanel405: 'Sie können nur Ihre eigenen Vorlagen bearbeiten',
  ...
  templatedbschemadependenciespanel457: 'Schreibgeschützte Vorlage',
  templatedbschemadependenciespanel469: 'Abhängigkeit entfernen',
  templatedbschemadependenciespanel483: 'Vorlage – DB-Schemaabhängigkeiten',
  templatedbschemadependenciespanel496: 'Vorlagen',
  ...
  templatedbschemadependenciespanel517: 'Vorlagen suchen...',
  templatedbschemadependenciespanel527: 'Keine Vorlagen verfügbar',
  templatedbschemadependenciespanel536: 'Vorlage',
  ...
  // resources/js/Components/Panels/TemplateDbSchemaDependenciesPanel.tsx
  templatedbschemadependenciespanel595: 'Wählen Sie eine Vorlage aus, um ihre DB-Schemaabhängigkeiten anzuzeigen',
  ...
  index378: 'Debug-Handbuchgenerator',
  index400: 'Willkommen',
  index413: 'Datenbank-Designer',
  index426: 'Vorlagen',
  ...
  index835: '🔧 Debug-Handbuchgenerator',
  index861: 'Projekt',
  ...
  landingpage171: 'Erweiterte Vorlagen',
  landingpage172: 'Benutzerdefinierte Vorlagenerstellung',
  ...
  api180: 'So wird die korrekte Verarbeitung der Vorlage dargestellt',
  ...
  api1330: 'Vorlage nicht gefunden',
  api1358: 'Ausnahme aufgetreten',
  api1379: 'Vorlage nicht gefunden',
  api1386: 'Vorlagenverarbeitung mit Projektfilter: {$projectId}',
  api1388: 'Vorlagenverarbeitung ohne Projektfilter (Demomodus)',
  api1393: 'Vorlagenverarbeitung mit Tabellenfilter: {$tableName}',
  ...
  gtreeultimate26: 'Vorlage nicht gefunden',
