...
// Lazy load panels
const AddressesManagementPanel = React.lazy(() => import('@/Components/Panels/AddressesManagementPanel'));
const CompaniesManagementPanel = React.lazy(() => import('@/Components/Panels/CompaniesManagementPanel'));
const ContactsManagementPanel = React.lazy(() => import('@/Components/Panels/ContactsManagementPanel'));
const CountriesManagementPanel = React.lazy(() => import('@/Components/Panels/CountriesManagementPanel'));
const CustomerAddressesManagementPanel = React.lazy(() => import('@/Components/Panels/CustomerAddressesManagementPanel'));
const CustomerContactsManagementPanel = React.lazy(() => import('@/Components/Panels/CustomerContactsManagementPanel'));
const CustomersManagementPanel = React.lazy(() => import('@/Components/Panels/CustomersManagementPanel'));
const LanguagesManagementPanel = React.lazy(() => import('@/Components/Panels/LanguagesManagementPanel'));
const PostalCodesManagementPanel = React.lazy(() => import('@/Components/Panels/PostalCodesManagementPanel'));
const UsersManagementPanel = React.lazy(() => import('@/Components/Panels/UsersManagementPanel'));
...
export default function Index() {
  ...
  registerPanel('address-management', 'Addresses Management', (
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <Suspense fallback={<PanelLoader />}>
        <AddressesManagementPanel />
      </Suspense>
    </ErrorBoundary>
  ));
  registerPanel('company-management', 'Companies Management', (
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <Suspense fallback={<PanelLoader />}>
  ...
  registerPanel('contact-management', 'Contacts Management', (
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <Suspense fallback={<PanelLoader />}>
  ...
  registerPanel('country-management', 'Countries Management', (
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <Suspense fallback={<PanelLoader />}>
        <CountriesManagementPanel />
      </Suspense>
    </ErrorBoundary>
  ));
  registerPanel('customer_address-management', 'CustomerAddresses Management', (
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <Suspense fallback={<PanelLoader />}>
        <CustomerAddressesManagementPanel />
      </Suspense>
    </ErrorBoundary>
  ));
  registerPanel('customer_contact-management', 'CustomerContacts Management', (
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <Suspense fallback={<PanelLoader />}>
        <CustomerContactsManagementPanel />
      </Suspense>
    </ErrorBoundary>
  ));
  registerPanel('customer-management', 'Customers Management', (
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <Suspense fallback={<PanelLoader />}>
  ...
  registerPanel('language-management', 'Languages Management', (
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <Suspense fallback={<PanelLoader />}>
        <LanguagesManagementPanel />
      </Suspense>
    </ErrorBoundary>
  ));
  registerPanel('postal_code-management', 'PostalCodes Management', (
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <Suspense fallback={<PanelLoader />}>
        <PostalCodesManagementPanel />
      </Suspense>
    </ErrorBoundary>
  ));
  registerPanel('user-management', 'Users Management', (
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <Suspense fallback={<PanelLoader />}>
