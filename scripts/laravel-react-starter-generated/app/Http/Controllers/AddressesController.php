...
class ProductController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'addr_house_number' => 'nullable|string|max:32',
            'pc_postal_code' => 'nullable|string|max:32',
            'pc_city' => 'nullable|string|max:128',
            'pc_state' => 'nullable|string|max:128',
            'count_iso2' => 'nullable|string|max:2',
            'addr_latitude' => 'nullable|numeric',
            'addr_longitude' => 'nullable|numeric',
            'addr_type' => 'nullable|string',
            'addr_is_primary' => 'nullable|integer',
            'addr_valid_from' => 'nullable|date',
            'addr_valid_to' => 'nullable|date',
            'addr_full_text' => 'required|string',
        ]);
