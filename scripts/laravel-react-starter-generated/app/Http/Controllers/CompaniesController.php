...
class ProductController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'comp_no' => 'required|integer',
            'comp_name' => 'required|string|max:255',
            'comp_registration_number' => 'nullable|string|max:128',
            'comp_vat_number' => 'nullable|string|max:64',
            'comp_website' => 'nullable|string|max:255',
            'comp_phone' => 'nullable|string|max:64',
            'comp_fax' => 'nullable|string|max:64',
            'comp_industry' => 'nullable|string|max:128',
            'comp_size' => 'nullable|string',
            'comp_notes' => 'nullable|string',
            'comp_created_at' => 'nullable|datetime',
            'comp_updated_at' => 'nullable|datetime',
        ]);
