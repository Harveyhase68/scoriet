...
-- Exportiere Struktur von Tabelle scoriet_customer_db.addresses
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.contact_methods
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.contacts
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.countries
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.customer_addresses
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.customer_contacts
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.customer_state
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.customers
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.foreign_currencies
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.languages
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.payment_bank_accounts
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.payment_credit_cards
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.payment_methods
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.post_codes
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.sales_discount
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.salutations
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.shops
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.titles
...
-- Exportiere Struktur von Tabelle scoriet_customer_db.users
