...
return new class extends Migration
{
    ...
    {
        // Create system user for global schemas and templates
        ...
        $ecommerceTemplate = DB::table('templates')->where('name', 'React E-Commerce Starter')->first();
        $blogTemplate = DB::table('templates')->where('name', 'Next.js Blog Platform')->first();
        $dashboardTemplate = DB::table('templates')->where('name', 'Vue.js Dashboard')->first();
    ...
    public function down(): void
    {
        ...
        DB::table('template_schema_dependencies')->whereIn('template_id',
            DB::table('templates')->where('creator_user_id',
                DB::table('users')->where('email', 'system@scoriet.dev')->value('id')
            )->pluck('id')
        )->delete();
