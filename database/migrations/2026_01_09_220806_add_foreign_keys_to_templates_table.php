...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('templates', function (Blueprint $table) {
            $table->foreign(['cloned_from_template_id'])->references(['id'])->on('templates')->onUpdate('no action')->onDelete('set null');
    ...
    {
        Schema::table('templates', function (Blueprint $table) {
            $table->dropForeign('templates_cloned_from_template_id_foreign');
