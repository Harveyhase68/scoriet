...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('template_files', function (Blueprint $table) {
            ...
            $table->string('inject_target')->nullable()->comment('Target file path for Smart Injection (e.g., routes/web.php)');
            $table->string('inject_tag')->nullable()->comment('Marker tag name for Smart Injection (e.g., routes)');
            $table->string('language_override', 10)->nullable();
            $table->timestamps();
