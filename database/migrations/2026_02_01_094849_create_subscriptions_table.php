...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('subscriptions', function (Blueprint $table) {
            ...
            $table->enum('subscription_type', ['project', 'schema', 'team', 'template', 'cli', 'service', 'bundle', 'form_designer', 'git_integration', 'code_adjustments', 'database_designer', 'schema_migration', 'message_attachments', 'kanban_board'])->nullable()->index();
