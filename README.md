...
JSON2PHP & JSON2WinDev, create from JSON a WinDev or PHP array template.

MySQL/MariaDB Update script, select version from -> version to, generate a update script.
